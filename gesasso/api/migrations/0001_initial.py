        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(
                    choices=[(1, 'OPEN'), (2, 'ASSIGNED'), (3, 'CLOSED'), (4, 'DONE'), (5, 'WAITING_TECH'),
                             (6, 'WAITING_FOR_TIERS_SERVICE'), (7, 'WAITING_FOR_CUSTOMER')], default=1)),
                ('origin',
                 models.PositiveSmallIntegerField(choices=[(1, 'WEB'), (2, 'MAIL'), (3, 'DIRECT'), (4, 'MERGE')],
                                                  default=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(
                    choices=[(1, 'PUBLIC'), (2, 'INTERNAL'), (3, 'SUCCESS'), (4, 'ERROR'), (5, 'INFO')], default=1)),
